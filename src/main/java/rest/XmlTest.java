...
public class XmlTest {
	...
	public static void before() {
		...
		//RestAssured.port = 80; //https a porta eh o 443
		//RestAssured.basePath = "/v2"; //se tiver versao
...
//			.spec(respSpec)
	...
	@Test
	public void devoTrabalharComXMLComNoRaiz() {
		given()
//			.spec(reqSpec)
		.when()
			.get("/usersXML/3")
...
//			.statusCode(200)
			...
			Assert.assertEquals("MARIA JOAQUINA", path.toUpperCase());
			...
			Assert.assertEquals("MARIA JOAQUINA", names.get(0).toString().toUpperCase());
